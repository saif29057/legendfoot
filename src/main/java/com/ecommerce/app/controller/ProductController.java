 ...
 * - Liskov Substitution: Can be substituted with any ProductController
 * implementation
 * - Interface Segregation: Provides only product-related methods
 * - Dependency Inversion: Depends on ProductService interface, not concrete
 * classes
 *
...
public class ProductController {
    ...
    public String showProduct(
        ...
        model.addAttribute("cartItemDto", CartItemDto.forCartAddition(
                product.getId(),
                product.getName(),
                product.getImageUrl(),
                product.getPrice(),
