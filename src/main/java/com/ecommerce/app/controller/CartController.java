...
public class CartController {
    ...
    public String addToCart(
        ...
        log.debug("Adding product to cart: {}", cartItemDto.getProductId());
        
        if (bindingResult.hasErrors()) {
            log.warn("Cart addition validation failed for product: {}", cartItemDto.getProductId());
            model.addAttribute("cartItemDto", cartItemDto);
            model.addAttribute("pageTitle", "Add to Cart");
            model.addAttribute("currentPage", "cart");
        ...
        try {
            cartService.addProductToCart(cartItemDto.getProductId(), cartItemDto.getQuantity());
            log.info("Product added to cart: {}", cartItemDto.getProductId());
            redirectAttributes.addFlashAttribute("successMessage", 
                    "Product added to cart successfully!");
            return "redirect:/cart";
            
        } catch (Exception e) {
            log.error("Failed to add product to cart: {}", cartItemDto.getProductId(), e);
    ...
    public String updateCartItem(
        ...
        if (bindingResult.hasErrors()) {
            ...
            model.addAttribute("cartItemDto", cartItemDto);
            model.addAttribute("pageTitle", "Update Cart");
            model.addAttribute("currentPage", "cart");
